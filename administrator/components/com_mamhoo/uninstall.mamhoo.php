<?php
/**
* $Id: uninstall.mamhoo.php,v 3.0  2007-05-31
* @package Mamhoo3.0
...
function com_uninstall()
{
	...
	// 'index.php?option=com_mamhoo&task=UserDetails'
	// to 'index.php?option=com_user&task=UserDetails'
	$sql = "UPDATE #__menu 
			SET `link`='index.php?option=com_user&task=UserDetails'
			WHERE `link`='index.php?option=com_mamhoo&task=UserDetails' ";
	$database->setQuery($sql);
	$database->query();


	# Show uninstallation result
	?>
	<center>
	<table width="100%" border="0">
	  <tr>
		<td>
		  ...
		  <?php echo _MAMHOO_LICENSE; ?>
		</td>
	  </tr>
	  <tr>
		<td>
		  <?php echo _MAMHOO_UNINST_SUCC; ?>
		</td>
	  </tr>
	  <tr>
		<td>
		  <?php echo _MAMHOO_UNINST_DESC; ?>
		</td>
	  </tr>
	</table>
	</center>
